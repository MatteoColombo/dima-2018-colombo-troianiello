...
\input{files/overall-description.tex}
\input{files/architectural-design.tex}
\input{files/interface-design.tex}
\input{files/software-system-attributes.tex}
\input{files/test-implementation.tex}
% ------------------------- % Fine del contenuto
